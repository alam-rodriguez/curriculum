...
import ContactApp from "../images/contact-app.png";

import TraveloCity from "../images/travelo-city-dcr.png";
    ...
    <div className="p-5">
      <div>
        ...
        <p className="fw-lighter m-1 text-dark">
          Hola, soy Alam Rodriguez, Front-End Developer. Me gusta programar y aprender nuevas tecnologías. Se HTML, CSS, JavaScript, Firebase y React, actualmente estoy estudiando Node y otros
          tecnologias.
          {/* llevo desde el 2021 aprendiendo a programar, aprendí HTML Y CSS en ese entonces, y luego
          aprendí JavaScript y React. Tengo un buen manejo de JavaScript y de React, soy capaz de crear o mantener un proyecto pequeño o mediano. Con mis conocimientos y su oportunidad podremos crear
          grandes cosas. */}
      ...
      <div>
        ...
        />
        <SectionRigthProyecto
          nombre="Travelo City DCR"
          info="Travelo City DCR es una aplicacion web de una agencia de viajes, en esta app puedes observar y reservar las actividades de la agencia, los usuarios incluso pueden realizar el pago de la reservacion y mandar por la misma web el comprobante del pago. esta app esta creada con React y Firebase, y ademas utiliza tecnologias como BootsTrap, nodemail, React router etc..."
          link="https://travelo-city-dcr.netlify.app/"
          imagen={TraveloCity}
          width="w-50"
        />
        ...
        <div>
          ...
          <div className="row">
            <SectionRigthEducacion
              ...
              periodo="2017-2021"
              info="En este periodo de tiempo conocí en mundo de las computadoras, estudié informática y ofimática, Aprendí a usar Word, PowerPoint y un poco de Excel. Además, estudia análisis de sistema. Pero de todo lo que más me gusto fue aprender HTML y CSS."
            />
            <SectionRigthEducacion
              estudio="Tecnico informatico"
              institucionYLugar="Youtube, platzi, Udemy | FreecodeCamp"
              periodo="2021-2023"
              info="Desde 2021 empecé a aprender totalmente por mi cuenta, en todo este proceso el deseo de programar a sido mi motor, he aprendido sobre HTML, CSS, JavaScript, Bootstrap, Firebase y actualmente estoy aprendiendo Node.js."
            />
          </div>
        </div>
      </div>
